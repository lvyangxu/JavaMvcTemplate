...
///将字符串解析为js的json对象,参数为待解析的字符串,返回解析后json对象
function stringToJsonObject(data) {
    var jsonResult = null;
